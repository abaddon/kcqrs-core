...
class RegistrationEventRouter: IRouteEvents {
    ...
    private val handlers: MutableMap<KType,(eventArgs: DomainEvent) -> IAggregate> = mutableMapOf()
...
//    }
    ...
    @OptIn(ExperimentalStdlibApi::class)
    override fun register(klass: KClass<*>, handler: (eventArgs: DomainEvent) -> IAggregate) {
